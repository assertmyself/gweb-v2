...
public class AppVersionController extends BaseCRUDActionController<AppVersion> {
    ...
    /* APP版本文件列表 */
    //private List appFiles = new ArrayList();
     ...
     * @param dstFilePath
     */
    private void copyFile(File srcFile, String dstFilePath) {
        try {
     ...
     * @param response HttpServletResponse
     * @param request HttpServletRequest
     * @param appVersionCode Long
     * @param updateContent String
            ...
            for (int i=0;i<su.getFiles().getCount();i++)
            {
                ...
                */
                ...
                if (-1 != fileName.indexOf(".apk")) {
                    ...
                    buffer.append("<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">"); buffer.append("\n");
                    buffer.append("<plist version=\"1.0\">");buffer.append("\n");
                    buffer.append("<dict>");buffer.append("\n");
                    buffer.append("<key>items</key>");buffer.append("\n");
                    buffer.append("<array>");buffer.append("\n");
                    buffer.append("<dict>"); buffer.append("\n");
                    buffer.append("<key>assets</key>");buffer.append("\n");
                    buffer.append("<array>");buffer.append("\n");
                    buffer.append("<dict>");buffer.append("\n");
                    buffer.append("<key>kind</key>");buffer.append("\n");
                    buffer.append("<string>display-image</string>"); buffer.append("\n");
                    buffer.append("<key>url</key>");buffer.append("\n");
                    buffer.append("<string>http://cloud.gsine.com.cn/gsapp/ios/ios_app_icon.png</string>");  buffer.append("\n");
                    buffer.append("<key>needs-shine</key>"); buffer.append("\n");
                    buffer.append("<string>YES/NO</string>");buffer.append("\n");
                    buffer.append("</dict>");  buffer.append("\n");
                    buffer.append("<dict>");  buffer.append("\n");
                    buffer.append("<key>kind</key>");   buffer.append("\n");
                    buffer.append("<string>software-package</string>");   buffer.append("\n");
                    buffer.append("<key>url</key>"); buffer.append("\n");
                    buffer.append("<string>https://cloud.gsine.com.cn/gsapp/ios/"+fileName+"</string>");  buffer.append("\n");
                    buffer.append("</dict>");  buffer.append("\n");
                    buffer.append("</array>");     buffer.append("\n");
                    buffer.append("<key>metadata</key>");         buffer.append("\n");
                    buffer.append("<dict>");        buffer.append("\n");
                    buffer.append("<key>bundle-identifier</key>"); buffer.append("\n");
                    buffer.append("<string>cn.com.gsine.app</string>"); buffer.append("\n");
                    buffer.append("<key>bundle-version</key>"); buffer.append("\n");
                    buffer.append("<string>"+versionName+"</string>");buffer.append("\n");
                    buffer.append("<key>kind</key>");  buffer.append("\n");
                    buffer.append("<string>software</string>"); buffer.append("\n");
                    buffer.append("<key>title</key>");buffer.append("\n");
                    buffer.append("<string>寰创通信</string>"); buffer.append("\n");
                    buffer.append("</dict>");  buffer.append("\n");
                    buffer.append("</dict>" );  buffer.append("\n");
                    buffer.append("</array>"); buffer.append("\n");
                    buffer.append("</dict>");  buffer.append("\n");
                    buffer.append("</plist>");  buffer.append("\n");
     ...
     */
    @RequestMapping
    public void save(HttpServletResponse response, @ModelAttribute("bean") AppVersion entity) throws Exception {
        try {
            AppVersion target;
