 ...
 * @date 下午5:42:20
 * @version v1.0.0
 * @see ApplicationLoadServlet
 */
public class ApplicationLoadServlet extends HttpServlet {
	private static final long serialVersionUID = -8108343328960389665L;
	private static final Logger LOG = Logger.getLogger(ApplicationLoadServlet.class);
	...
	public void init() throws ServletException {
		...
		try {
			...
			LOG.error(AlarmTempletFactory.class
					+ " : Parse Alarm template failed!!!",e1);
