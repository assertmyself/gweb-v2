    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if (!form.data('jqv') || form.data('jqv') == null) {
                ...
                $(".formError").on("click", function () { //live to on
        ...
        _validateField: function (field, options, skipAjaxValidation) {
            ...
            if (options.isError) {
                promptText = options.beforeShowErrorMsg(field, promptText, "", false, options) || promptText;
        ...
        _buildPrompt: function (field, promptText, type, ajaxed, options) {
            ...
            if (options.relative) {
                ...
                $(field).parent().append(outer);
//                $(field).after(outer);  //会造成后面的元素换行
                ...
                switch (positionType) {
                    ...
                    case "topRight":
                        if (overflow) {
                            ...
                            promptTopPosition += -field.height() - 2;  //调整位置
                        } else {
                            promptleftPosition += fieldWidth - 30;
                    ...
                    case "bottomRight":
                        promptleftPosition += fieldWidth - 30;
//						promptTopPosition += field.height() + 5;  //原代码
                        promptTopPosition += promptHeight - field.height() / 2;     //调整位置
                }
            }
            else {
                switch (positionType) {
