...
function handle_side_menu() {
    ...
    function(g) {
        ...
        //如果是点的二级item，为父类添加open ,active ,否则删除父类的open
        if(f.parent().parent().hasClass("submenu")){
        	f.parent().parent().parent().addClass("open").addClass("active");
        }else{
        ...
        //fix TypeError:d isundefined @autor doujun
        	f.addClass("active");
        }else{
        	if (!$(d).is(":visible")) {
