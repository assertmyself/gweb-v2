...
<div class="container" style="width: 100%;">
    ...
    <form id="fileuploadForm" action="${ctx}/docCommon/uploadFile.do" method="post"
        ...
        <div class="row fileupload-buttonbar">
            <c:if test="${canEdit}">
                ...
                <span class="btn btn-success fileinput-button">
                    ...
                    <input type="hidden" name="xmlConfig" id="xmlConfig" value="${xmlConfig}"/>
...
//            acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,
        ...
        $('#fileuploadForm').each(function () {
            var that = this;
            $.getJSON('${ctx}/docCommon/getAttachFileList.do?docId=' + $("#docId").val()
                    + "&bizCode=" + $("#bizCode").val() + "&secondDir=" + $("#secondDir").val(), function (result) {
